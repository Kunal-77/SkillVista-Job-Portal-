...
import { AppContext} from '../context/AppContext'; // ✅ Use the context, not provider

const Hero = () => {
    const { setSearchFilter, setIsSearched } = useContext(AppContext); // ✅ Correct usage
    ...
    const onSearch = () => {
        ...
        // setSearchFilter(`${title} ${location}`.trim());
        // setIsSearched(true);
    };
