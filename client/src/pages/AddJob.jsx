    ...
    return (
        <form className='container p-4 flex flex-col w-full items-start gap-3'>
            ...
            <div>
                ...
                <input min={0} className='w-full px-3  py-2 border-2 border-gray-300 rounded sm:w-[120px]' onChange={(e) => setSalary(e.target.value)} value={salary} type="Number" placeholder='type here' />
